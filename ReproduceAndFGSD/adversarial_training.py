...
from engine import train, validate, adversarial_training
...
if __name__ == '__main__':
    ...
    if args.throughput:
        ...
        scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer,
                                                         T_max=ceil(len(train_loader) / update_freq) * epochs)
        ...
        for i in range(start_epoch, epochs):
            ...
            train_loss = adversarial_training(model, loss_fn, optimizer, device, train_loader, scheduler, loss_scaler, update_freq,
                               mixup, random_erase)

            val_loss, top_1_val_acc, top_5_val_acc = validate(model, device, val_loader, i,
                                                              can_visualize=False)
            ...
            torch.save({
                ...
                'start_epoch': i,
            }, f'models/{args.model}/epoch{i + 1}_top1_acc:{top_1_val_acc}_top5_acc{top_5_val_acc}.pth')
